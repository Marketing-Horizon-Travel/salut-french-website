...
module.exports = function (eleventyConfig) {
    ...
    // ============================================================
    // Flat line icons (Lucide-style). Use: {% icon "graduation-cap", 28 %}
    // ============================================================
    const ICONS = {
        ...
        "leaf": '<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96a1 1 0 0 1 1.8.5c-.49 9.18-7.74 14.36-15 14.54Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/>',
        ...
        "clipboard-edit": '<rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M10.4 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7.5"/><path d="M13.378 15.626a1 1 0 1 0-3.004-3.004l-5.01 5.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z"/>',
    ...
    eleventyConfig.addShortcode("icon", function (name, size = 24) {
        ...
        if (!inner) return ""; // unknown icon → empty so emoji never leaks if data wasn't migrated
        return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-${name}" aria-hidden="true">${inner}</svg>`;
    });
